...
@Component({
    ...
    template: `
      <div [formGroup]="form">
        <input *ngIf="!field.multiline" [attr.placeholder]="field.placeholder" [attr.type]="field.type" class="form-control"  [id]="field.name" [name]="field.name" [formControlName]="field.name">
